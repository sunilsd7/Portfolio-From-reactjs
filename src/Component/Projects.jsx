    ...
    <div id='projects'>
      ...
      <div className="md:grid md:grid-cols-2 px-5 gap-16 mt-5">
        <div className='border-2 p-5 my-4 rounded-[1rem] '>
            ...
            <p className='font-bold text-2xl mt-3'>Furniture Website: Demo project using react</p>
            ...
            <p className='font-bold text-xl mt-3'>Medi-mitra: A smart Vaccination management System</p>
